...
public class SmartDialogBuilder {
    ...
    private int headerTextColor, descriptionTextColor;
    ...
    public SmartDialogBuilder setTitleColor(int headerTextColor) {
        this.headerTextColor = headerTextColor;
        return this;
    }

    public SmartDialogBuilder setSubTitleColor(int descriptionTextColor) {
    ...
    public SmartDialogBuilder setCustomIcon(int icon) {
    ...
    public SmartDialog build() {
        SmartDialog dialog = new SmartDialog(context, backgroundColor, title, subtitle, titleTf, subTitleTf, isCancelable, isNegativeBtnHide,
                hasNeutralBtn,customIcon,headerTextColor,descriptionTextColor);
